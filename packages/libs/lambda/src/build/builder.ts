...
import { ImageBuildManifest, PageManifest } from "@cryptodiffer-sls-next/core";
import CoreBuilder from "@cryptodiffer-sls-next/core/dist/build/builder";
import { Manifest, CoreBuildOptions } from "@cryptodiffer-sls-next/core";
...
export class LambdaBuilder extends CoreBuilder {
  ...
  protected async processAndCopyHandler(
    ...
    const source = path.dirname(
      require.resolve(
        `@cryptodiffer-sls-next/lambda/dist/bundles/${handlerType}/${
