...
import { addDefaultLocaleToPath, getAcceptLanguageLocale, getLocaleDomainRedirect } from "./locale";
 ...
 * @param statusCode
 */
export function createRedirectResponse(uri, querystring, statusCode) {
    let location;
 ...
 * @param manifest
 */
export function getDomainRedirectPath(request, manifest) {
 ...
 * @param manifest
 */
export async function getLanguageRedirectPath(req, manifest, routesManifest) {
    var _a, _b, _c;
 ...
 * @param routesManifest
 */
export function getRedirectPath(request, routesManifest) {
    var _a;
 ...
 * @param manifest
 */
export function getTrailingSlashPath(request, manifest, isFile) {
    const { uri } = request;
    if (isFile) {
