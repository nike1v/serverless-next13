 ...
 * @param source
 */
export function matchPath(path, source) {
 ...
 * @param params
 */
export function compileDestination(destination, params) {
    try {
...
export const matchDynamic = (uri, routes) => {
...
export const matchDynamicRoute = (uri, routes) => {
