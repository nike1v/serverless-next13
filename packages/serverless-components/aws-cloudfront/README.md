...
It is being used by the [nextjs serverless component](https://github.com/nike1v/serverless-next13/tree/master/packages/serverless-component) to provision the CloudFront distribution behind the scenes.
