...
**Note:** Version bump only for package @dolsze/cryptodiffer-serverless-nextjs-monorepo
...
**Note:** Version bump only for package cryptodiffer-serverless-nextjs-monorepo
...
- add missing dep ([9cc6a9d](https://github.com/serverless-nextjs/serverless-next.js/commit/9cc6a9d79ffbe7507dc217f6a9b60b85a566a911))
- add missing dep to example ([f7a47be](https://github.com/serverless-nextjs/serverless-next.js/commit/f7a47bed0cdcccf675f972c124f9ceb53fa9ddbd))
...
- bind providerRequest and consoleLog to prevent ctx issues ([a092ae7](https://github.com/serverless-nextjs/serverless-next.js/commit/a092ae7f1af9e1c454eea43809a132927070dfdb))
...
- don't exclude \_error page from build ([4968928](https://github.com/serverless-nextjs/serverless-next.js/commit/496892885903af68300c1c89fa3935e1dbcbe63b))
...
- ensure handler is always posix ([a0f932c](https://github.com/serverless-nextjs/serverless-next.js/commit/a0f932c94051a083ebdabe2d2f87c744e16da3fd))
...
- fix example ([e0d94c7](https://github.com/serverless-nextjs/serverless-next.js/commit/e0d94c72803036f84525fc59b29f8ce125280084))
- fix reading compatCode template and better tests ([672c08d](https://github.com/serverless-nextjs/serverless-next.js/commit/672c08d575864e87ade1d20b0442c44a332cf8d6))
...
- handle empty req url ([#315](https://github.com/serverless-nextjs/serverless-next.js/issues/315)) ([ad7bec1](https://github.com/serverless-nextjs/serverless-next.js/commit/ad7bec1827ad3b6074c6f1a085a57a2d906334ba))
...
- listening for right event on stderr of sls-offline. rearranged install steps on travis ([06a9a25](https://github.com/serverless-nextjs/serverless-next.js/commit/06a9a25c6d40bc61d87ee603ef5cf59fd5dca607))
...
- make next,react,react-dom peerDeps ([a692ea3](https://github.com/serverless-nextjs/serverless-next.js/commit/a692ea36cdbb911b58e81b069d9e219f41635040))
...
- NextPages now have correct pagePath when next.config is nested in a subdir ([60c9b3a](https://github.com/serverless-nextjs/serverless-next.js/commit/60c9b3aaec7b573ee040532e7d3c91b8934d2454))
...
- only set next as a peer dep ([2746ebb](https://github.com/serverless-nextjs/serverless-next.js/commit/2746ebbac6539978fcb6fbd15405b846cb18b7d8))
- pageRoutes now handle correctly build directories with multiple levels ([d14045a](https://github.com/serverless-nextjs/serverless-next.js/commit/d14045a266deb7f9581b41c6290bb3743f4c31bd))
- parse non-alphanumeric characters in resourceName ([#82](https://github.com/serverless-nextjs/serverless-next.js/issues/82)) ([81f63cc](https://github.com/serverless-nextjs/serverless-next.js/commit/81f63ccb4477d50d7b3b26fc6e428886b2d49798))
...
- relative path to compatLayer fixed when build directory is nested ([4970af1](https://github.com/serverless-nextjs/serverless-next.js/commit/4970af1172a7de9cf774ca6bd5c3811b580bf173))
- resolve relative path to custom handler ([#63](https://github.com/serverless-nextjs/serverless-next.js/issues/63)) ([bc2afac](https://github.com/serverless-nextjs/serverless-next.js/commit/bc2afac6023605198b096fa2f153bffb6d535d54))
- s3 upload file paths fix ([7e19f03](https://github.com/serverless-nextjs/serverless-next.js/commit/7e19f037726916d69241bb63afe2814ce88a2c8d))
...
- Set asset files Content-Type before uploading to S3 ([b563acd](https://github.com/serverless-nextjs/serverless-next.js/commit/b563acdaa0ac4aae9ee5161b7060a579d949e40d))
- simplify how relative path to compatLayer is calculated ([60cdf9d](https://github.com/serverless-nextjs/serverless-next.js/commit/60cdf9d7b05813cfcdef8f851a5d7449f66c51c2))
...
- truncate correctly S3 Keys ([b30c312](https://github.com/serverless-nextjs/serverless-next.js/commit/b30c312b2e3703167b9bbc1c0fa675f1866de8e4))
...
- unit and integration tests pass in windows ([b35e5be](https://github.com/serverless-nextjs/serverless-next.js/commit/b35e5be2a29ce55cf25faf5e6535dfbdaf3a3cd6))
...
- update coreCloudFormationTemplate with bucket and upload assets before stack update ([df50ee2](https://github.com/serverless-nextjs/serverless-next.js/commit/df50ee23faf096b00009a89ca570e27b503ac89d))
- update examples exclude glob to ./\*\* ([c05d0e5](https://github.com/serverless-nextjs/serverless-next.js/commit/c05d0e5b6e54d6cb9ad2eb3d738ff5d093fab528))
- upload static assets when bucket name is provided via plugin config ([bd42974](https://github.com/serverless-nextjs/serverless-next.js/commit/bd42974805bb8523831fc37e3abb70eb3d263e62))
- use provider.getRegion correctly ([b39e9ce](https://github.com/serverless-nextjs/serverless-next.js/commit/b39e9cec6becca64c0e270a9bf7795bde0584b53))
- use region in bucket url when required ([#76](https://github.com/serverless-nextjs/serverless-next.js/issues/76)) ([3d60ac4](https://github.com/serverless-nextjs/serverless-next.js/commit/3d60ac4734500a07125f1a15e622b9f78a962181))
...
- Use pageId as identifier (#72) ([506d3ba](https://github.com/serverless-nextjs/serverless-next.js/commit/506d3ba81b4b3e7e777d9cf04a1490e6c7a1fd50)), closes [#72](https://github.com/serverless-nextjs/serverless-next.js/issues/72)

### Features

- add assets bucket validation ([#83](https://github.com/serverless-nextjs/serverless-next.js/issues/83)) ([c0cc12b](https://github.com/serverless-nextjs/serverless-next.js/commit/c0cc12b803d70a12caf218ec0b41ac77d96c1666))
- add capability for custom next build dir and fix an issue with require path ([ca3e06c](https://github.com/serverless-nextjs/serverless-next.js/commit/ca3e06c9a3abcdf9db34a9dad35ff644080003fa))
- add custom bucket name to plugin options ([25afa75](https://github.com/serverless-nextjs/serverless-next.js/commit/25afa759d80c2007852614f144768eccd40019ad))
- add custom input for lambda(s) timeout ([#275](https://github.com/serverless-nextjs/serverless-next.js/issues/275)) ([236231e](https://github.com/serverless-nextjs/serverless-next.js/commit/236231e83e5d82ca1061dddab4106961883bbda1))
- add custom inputs for lambda name ([#283](https://github.com/serverless-nextjs/serverless-next.js/issues/283)) ([704120b](https://github.com/serverless-nextjs/serverless-next.js/commit/704120b28f0747efec9490ab5bcd3a161a9c7253)), closes [#232](https://github.com/serverless-nextjs/serverless-next.js/issues/232)
- add HEAD http event to NextPages ([#43](https://github.com/serverless-nextjs/serverless-next.js/issues/43)) ([eb9a6f4](https://github.com/serverless-nextjs/serverless-next.js/commit/eb9a6f4709ae7d1911e0fe16b7b392e571d67b1a))
- add logging when uploading files ([23be3de](https://github.com/serverless-nextjs/serverless-next.js/commit/23be3debaa50243b8b435fc5ff87ca1303407822))
- add resources for static assets bucket ([40a2452](https://github.com/serverless-nextjs/serverless-next.js/commit/40a245241ab04cd5c4fc14f58b83344b5a657b75))
- add support for custom 404 error pages ([92da22d](https://github.com/serverless-nextjs/serverless-next.js/commit/92da22ded9539c702635032630d27f334ef88060))
- add support for custom page routes ([a577721](https://github.com/serverless-nextjs/serverless-next.js/commit/a5777211a6d39c1c2853b3304c2d22e69a4f535c))
- add support for deploying single function ([5e634d7](https://github.com/serverless-nextjs/serverless-next.js/commit/5e634d74fd138ee85d1f6a8d08abd245c2d3dcd2))
- add support for nested page directories ([1e6f7c3](https://github.com/serverless-nextjs/serverless-next.js/commit/1e6f7c3776581c56fb47bc93bf9984debd669d95))
- add support for nested page directories ([394a7fc](https://github.com/serverless-nextjs/serverless-next.js/commit/394a7fceb7bbd61bd384fea699f80a5b8ae9dc46))
- add very basic support for sls-offline ([d97a9dd](https://github.com/serverless-nextjs/serverless-next.js/commit/d97a9dd2bb9d40635f995e6c0539610b32dead1c))
- added implementation for getCompatLayerCode ([febcbe8](https://github.com/serverless-nextjs/serverless-next.js/commit/febcbe8dfde45a44341c57b80a85c6607bbcb0f8))
- adding new user provided pageConfig ([ba27197](https://github.com/serverless-nextjs/serverless-next.js/commit/ba27197e9db4ae6c673b75bbba5c54b36ff1c0bd))
- allow assets bucket name to be provided via config ([1c417f3](https://github.com/serverless-nextjs/serverless-next.js/commit/1c417f33d39106470564cc5680f4b6c7e4bd8eea))
...
- allow users to override cloudfront configuration ([3783dc4](https://github.com/serverless-nextjs/serverless-next.js/commit/3783dc4502329ce713b20a26edb2919ada145c63))
...
- better terminal info when deploying ([23f3796](https://github.com/serverless-nextjs/serverless-next.js/commit/23f379640ea88a002136d565390ec412b6902373))
...
- completed user provided page configs support. Need to add more int tests ([3a22144](https://github.com/serverless-nextjs/serverless-next.js/commit/3a22144a515d768b83589d866f838df628d6fd76))
...
- display on the CLI bucket details output ([1dbc133](https://github.com/serverless-nextjs/serverless-next.js/commit/1dbc133fd153d6e129df11f0048ed15bf27a8694))
- dynamic page functions support completed. ([e8b0940](https://github.com/serverless-nextjs/serverless-next.js/commit/e8b094052fd6b2a1ed385226065eb7b7a8cdc70e))
...
- function to get page handlers from next build dir ([8dc5db9](https://github.com/serverless-nextjs/serverless-next.js/commit/8dc5db90584085fde73cb13b0982c78409907e68))
- global page config ([#66](https://github.com/serverless-nextjs/serverless-next.js/issues/66)) ([61bc586](https://github.com/serverless-nextjs/serverless-next.js/commit/61bc586afcd884850664304e6856ac67ff159c0f))
- ignore subdomain if not present ([#231](https://github.com/serverless-nextjs/serverless-next.js/issues/231)) ([ac2f819](https://github.com/serverless-nextjs/serverless-next.js/commit/ac2f819d57e361f6bd5241383eb83ecb6ec776d9))
- index page now served at / ([c042972](https://github.com/serverless-nextjs/serverless-next.js/commit/c0429723b56d31053f794a65f5e5dfacb8992a5e))
...
- Make s3 static assets bucket optional ([75aea4e](https://github.com/serverless-nextjs/serverless-next.js/commit/75aea4ee89ad9e32e70a63a372e0fa01194fdec1))
- memory input for lambdas ([#255](https://github.com/serverless-nextjs/serverless-next.js/issues/255)) ([54dfaa2](https://github.com/serverless-nextjs/serverless-next.js/commit/54dfaa2762f6e809d064880973948eb2b2ccc82c))
...
- **nextjs-component:** enable custom domain names ([d8c3f97](https://github.com/serverless-nextjs/serverless-next.js/commit/d8c3f97aedcfd8d8dcdda1a5174696aa3eea02ed))
...
- parse configuration needed directly from next.config.js. ([fe13d55](https://github.com/serverless-nextjs/serverless-next.js/commit/fe13d55a6ea8093e1608d2ded291c4c11d58e3f7))
- plugin includes build directory in artifacts automatically ([0957896](https://github.com/serverless-nextjs/serverless-next.js/commit/09578961ac3aeb88a14cb7aeaab0ff81f42b5468))
- plugin now picks up functions dynamically. Need to sort packaging excludes/includes ([111f3ad](https://github.com/serverless-nextjs/serverless-next.js/commit/111f3ada6fec964d742ccd4f9fb6284b0174d503))
- plugin now picks up functions dynamically. Need to sort packaging excludes/includes ([af42a56](https://github.com/serverless-nextjs/serverless-next.js/commit/af42a561629f94123da49b8b3e38754aef5bbc9d))
- remove limitation of having to specify serverless target. Plugin does it for you now ([c248c2f](https://github.com/serverless-nextjs/serverless-next.js/commit/c248c2fb852be0eb8d33952e5bc2a4b758cd3ffc))
- replace bucketname in cf resource with plugin provided ([25299c2](https://github.com/serverless-nextjs/serverless-next.js/commit/25299c2f4e575af915cd9d93022b45e521ecb50d))
...
- skip underscore page handlers ([39f1265](https://github.com/serverless-nextjs/serverless-next.js/commit/39f1265e25a0c0045b27186124b5e8e1ddc9f2af))
...
- static assets now upload to S3 ([e3b675e](https://github.com/serverless-nextjs/serverless-next.js/commit/e3b675e9f84f3790d796fae46136b91822f1cb47))
- swaping original next handlers with compat ones now working ([c6c0487](https://github.com/serverless-nextjs/serverless-next.js/commit/c6c0487e18fc53348ad97f64d8ef7431d2052b57))
- tmp build directory is now removed after serverless finishes packaging ([e602dd6](https://github.com/serverless-nextjs/serverless-next.js/commit/e602dd63cc468bf3ab66d97552025d02aeb95243))
...
- working in compat layer stuff ([8e88dcc](https://github.com/serverless-nextjs/serverless-next.js/commit/8e88dcca013e863fa2fa0badac3f553da4674f1a))
- working in swapping the original handler with the compat ([3643249](https://github.com/serverless-nextjs/serverless-next.js/commit/3643249913a3a7769cfcb98fcd2ca1d79d64504e))
- working in walking dir in prep for uploading to S3 ([be5c12e](https://github.com/serverless-nextjs/serverless-next.js/commit/be5c12e21f4f278038f36c6a032d2952cf75c62a))
- working on file upload to s3 bucket and tidy up tests ([e50442d](https://github.com/serverless-nextjs/serverless-next.js/commit/e50442dccd88095383f63315c0d43b72497c6368))
- working on injecting compat layer to nextjs page handlers ([cce3e57](https://github.com/serverless-nextjs/serverless-next.js/commit/cce3e57cbddc9ac6d3186c7f4d99ad56f9bb4be4))
...
- Revert "test: remove flaky test" ([86f1ced](https://github.com/serverless-nextjs/serverless-next.js/commit/86f1ced270d724c6235702540084d272ee0b1211))
...
- pageConfig now must include the relative path of the page
